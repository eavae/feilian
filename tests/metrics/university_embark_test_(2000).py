...
## 结果如下
# //title/text() 
#  //td[@class='tdContent']//span[@class='label' and text()='Phone:']/following-sibling::span[@class='data']/text() 
#  //td[@class='tdContent']/span/table[@class='details']/tbody/tr/td[@class='label' and text()='School Type:']/following-sibling::td[@class='data'][1]/text() 
#  //td[@class='tdContent']//span[@class='label' and text()='Website:']/following-sibling::span[@class='data']/a/@href
...
# 设置 HTML 文件所在的目录路径
htm_path = "/Users/brycewang/Desktop/智能爬虫/data/swde/sourceCode/sourceCode/university/university-embark(2000)/"
...
# 0  1902.htm  [ , \n\tSchool Profile\n]  [314 935-6880, 314 935-4887]   []  [http://www.artsci.wustl.edu/GSAS]
# 1  1916.htm  [ , \n\tSchool Profile\n]                [816 259-2221]   []            [http://www.wma1880.org]
# 2  1080.htm  [ , \n\tSchool Profile\n]  [401 434-4840, 401 434-9540]   []         [http://www.mtti.tec.ri.us]
# 3  1094.htm  [ , \n\tSchool Profile\n]  [801 484-7624, 801 484-1928]   []  [http://www.myotherapycollege.com]
# 4  0361.htm  [ , \n\tSchool Profile\n]                [614 287-2400]   []               [http://www.cscc.edu]
# (2000, 5)
# [' ', '\n\tSchool Profile\n']   ['314 935-6880', '314 935-4887']   []   ['http://www.artsci.wustl.edu/GSAS']
...
print("---------------------------------------------")
#   filename                         phone
# 0  1902.htm  [314 935-6880, 314 935-4887]
# 1  1916.htm                [816 259-2221]
# 2  1080.htm  [401 434-4840, 401 434-9540]
# 3  1094.htm  [801 484-7624, 801 484-1928]
# 4  0361.htm                [614 287-2400]
# (2000, 2)
...
## 结果如下
#    filename                       name                         phone       type                             website
# 0  1902.htm  [ , \n\tSchool Profile\n]  [314 935-6880, 314 935-4887]  [Private]  [http://www.artsci.wustl.edu/GSAS]
# 1  1916.htm  [ , \n\tSchool Profile\n]                [816 259-2221]  [Private]            [http://www.wma1880.org]
# 2  1080.htm  [ , \n\tSchool Profile\n]  [401 434-4840, 401 434-9540]  [Private]         [http://www.mtti.tec.ri.us]
# 3  1094.htm  [ , \n\tSchool Profile\n]  [801 484-7624, 801 484-1928]  [Private]  [http://www.myotherapycollege.com]
# 4  0361.htm  [ , \n\tSchool Profile\n]                [614 287-2400]   [Public]               [http://www.cscc.edu]
# (2000, 5)
# [' ', '\n\tSchool Profile\n']   ['314 935-6880', '314 935-4887']   ['Private']   ['http://www.artsci.wustl.edu/GSAS']
